...
__all__ = ['get_full_boxscore', 'get_game_info', 'hash_game', 'get_page_soup', 'request_type', 'get_boxscore',
...
def get_full_boxscore(
    ...
    return _temp_get_full_boxscore(
...
def get_all_boxscores_from_linescore_page(
    ...
    return [_temp_get_full_boxscore(soup=soup,soup_type=soup_type,draw_kwargs=draw_kwargs,game_kwargs = {**game_kwargs,'game_number':i+1}) for i in range(game_numbers)]
